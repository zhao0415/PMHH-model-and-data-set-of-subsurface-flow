...
#)/(x_a2*self.inisw2+self.PreF1a+self.P)        
        ...
        self.concg =self.conci =(x9*self.P*self.Pi+(self.PreF2)*self.Piacc/self.Pacc+x1*self.inisw1*self.concs1mo+x5*self.inisw2*self.concs2mo/(self.PreF2+x1*self.inisw1+x5*self.inisw2+x9*self.P)#(x9*self.P*self.Pi+(self.PreF2)*self.Piacc/self.Pacc+x1*self.inisw1*self.concs1mo+x5*self.inisw2*self.concs2mo)/((self.PreF2)+x1*self.inisw1+x5*self.inisw2+x9*self.P)#
